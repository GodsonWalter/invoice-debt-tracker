...
class PlatformDashboardRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        if (! $this->filled('period')) {
            $this->merge([
                'period' => $this->filled('range') ? $this->input('range') : WorkspaceDashboardPeriod::DASHBOARD_DEFAULT,
            ]);
        }
    }
    ...
    public function dashboardPeriod(): WorkspaceDashboardPeriod
    {
        return WorkspaceDashboardPeriod::fromInput(
            period: $this->string('period')->toString() ?: WorkspaceDashboardPeriod::DASHBOARD_DEFAULT,
    ...
    private function supportedPeriods(): array
    {
        return [
            ...
            WorkspaceDashboardPeriod::TODAY,
            WorkspaceDashboardPeriod::LAST_7_DAYS,
