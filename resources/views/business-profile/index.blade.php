    ...
    <div class="container-fluid py-2">
        ...
        <div class="card border border-light shadow-sm rounded-4 overflow-hidden">
            <div class="card-body p-4">
                <form action="{{ route('business-profile.update', $businessProfile) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="business_name" class="form-control"
                            value="{{ old('business_name', $businessProfile->business_name) }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($businessProfile->logo)
                            <div class="mt-2"><img src="{{ asset('storage/' . $businessProfile->logo) }}" alt="logo"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="state" class="form-control"
                                value="{{ old('state', $businessProfile->state) }}">
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="country" class="form-control"
                                value="{{ old('country', $businessProfile->country) }}">
                        </div>
