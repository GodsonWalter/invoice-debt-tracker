...
<div class="item-row border rounded-3 p-3 mb-3" data-index="0">
                                <div class="row g-2 align-items-end">
                                    <div class="col-12 col-md-3">
                                        ...
                                        <input type="text" name="items[0][item_name]" class="form-control" value="{{ old('items.0.item_name') }}" required>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label class="form-label">Description</label>
                                        <input type="text" name="items[0][description]" class="form-control" value="{{ old('items.0.description') }}">
                                    </div>
                                    <div class="col-6 col-md-2">
                                        <label class="form-label">Qty</label>
                                        <input type="number" min="1" name="items[0][quantity]" class="form-control" value="{{ old('items.0.quantity', 1) }}" required>
                                    </div>
                                    <div class="col-6 col-md-2">
                                        <label class="form-label">Unit Price</label>
                                        <input type="number" step="0.01" min="0" name="items[0][unit_price]" class="form-control" value="{{ old('items.0.unit_price', 0) }}" required>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label class="form-label">Total</label>
                                        <input type="number" step="0.01" min="0" name="items[0][total_price]" class="form-control" value="{{ old('items.0.total_price', 0) }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="number" step="0.01" min="0" name="subtotal" class="form-control" value="{{ old('subtotal', 0) }}" readonly>
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">Tax Amount</label>
                                <input type="number" step="0.01" min="0" name="tax_amount" class="form-control @error('tax_amount') is-invalid @enderror" value="{{ old('tax_amount', 0) }}">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">Discount Amount</label>
                                <input type="number" step="0.01" min="0" name="discount_amount" class="form-control @error('discount_amount') is-invalid @enderror" value="{{ old('discount_amount', 0) }}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Total Amount</label>
                                <input type="number" step="0.01" min="0" name="total_amount" class="form-control" value="{{ old('total_amount', 0) }}" readonly>
                            </div>
                            <div class="col-12 col-md-6">
